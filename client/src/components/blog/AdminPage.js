        ...
        <Display>
          {this.props.comp === "Posts" ? (
            <Posts
              ...
              onModDisplay={this.props.onModDisplay}
              articles={this.props.articles}
            />
          ) : this.props.comp === "Users" ? (
            <Users />
          ) : this.props.comp === "Creator" ? (
            <Creator postArticle={(draft) => this.props.onPostArticle(draft)} />
          ) : this.props.comp === "success" ? (
            <ServerResp msg={this.props.msg} />
          ) : (
            ""
          )}
        </Display>
